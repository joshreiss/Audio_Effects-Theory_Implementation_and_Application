...
private:
  ...
  juce::AudioParameterFloat* coneOuterGainParam;
  juce::AudioParameterFloat* coneInnerAngleParam;
  juce::AudioParameterFloat* coneOuterAngleParam;
  juce::AudioParameterFloat* refDistanceParam;
  juce::AudioParameterFloat* rolloffParam;
  class DelayLine
  {
  public:
